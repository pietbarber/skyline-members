...
define('STR_LOGIN_INI_MISSINGSLASH', 'Le chemin slash "%s" pour l\'utilisateur [%s] est incorrect (user.ini).');
...
define('STR_RENAMEENTERNEWNAME', 'entre le nouveau nom pour %s:');
...
define('STR_EDITOR_SAVE_ERROR_HEX_VALUE_NEEDED','En accord avec les paramètres, vous devez saisier une value hexadécimale positive comprise entre 00 et FF.');
define('STR_EDITOR_SAVE_ERROR_DEC_VALUE_NEEDED','En accord avec les paramètres, vous devez saisier un entier hexadécimal positif compris entre 0 et 255.');
...
define('STR_FILE_UPLOAD_ERROR_FILE_PARTIAL',          'Erreur : Le fichier téléchargé %s était partiellement téléchargé');
...
define('STR_SELECTOR_BYPERMISSION',		'par permission'); // keep this string short
define('STR_SELECTOR_BYDATETIME',		'par date/heure');  // keep this string short
