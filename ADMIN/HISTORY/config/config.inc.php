...
#$default['USER_CONFIGFILE'] = 'please move the user.ini file to a safe place first';
$default['USER_CONFIGFILE'] = '/var/www/members/history.ini';
...
// - do not set it too high (try to keep it below ~500000, that ~0.5MB)
