...
- Automatically generated by $user on $date UTC
  ...
  my $sql = qq( set DateStyle TO 'SQL, YMD'; select members.firstname, members.middleinitial, members.lastname, members.namesuffix, members.handle, (new_contacts.join_date + 45) as valid_till from new_contacts inner join members on members.handle = new_contacts.handle where new_contacts.join_date < CURRENT_DATE and members.memberstatus='T' or members.memberstatus='E'
